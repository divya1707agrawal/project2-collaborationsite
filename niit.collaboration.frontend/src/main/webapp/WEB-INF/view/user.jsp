                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.mobile" id="mobile" class="form-control input-sm" placeholder="Enter your mobile number. [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
          ...
          <div class="panel panel-default">
              ...
              <div class="tablecontainer">
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.users track by $index" >
                              <td><span ng-bind="u.id">{{ u.id }}</span></td>
                              <td><span ng-bind="u.name">{{ u.name }}</span></td>
                              <td><span ng-bind="u.password">{{ u.password }}</span></td>
                              <td><span ng-bind="u.address">{{ u.address }}</span></td>
                              <td><span ng-bind="u.email">{{ u.email }}</span></td>
                              <td><span ng-bind="u.mobile">{{ u.mobile }} </span></td>
                              <td>
