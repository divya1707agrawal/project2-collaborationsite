                      ...
                      <div class="row">
                       ...
                       <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.password" id="password" class="form-control input-sm" placeholder="Enter your password. [This field is validation free]" required/>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.mobile" id="mobile" class="form-control input-sm" placeholder="Enter your mobile number. [This field is validation free]" pattern = "[0-9]{10}" required/>
                              </div>
                          </div>
                      </div>
