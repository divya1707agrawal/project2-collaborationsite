...
<title>Insert title here</title>
 <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.4.8/angular.min.js"></script>
   <script src="<c:url value='/static/app.js' />"></script>
      <script src="<c:url value='/static/chatforum_controller.js' />"></script>
      <script src="<c:url value='/static/chatforum_service.js' />"></script> 
...
<div class="generic-container" ng-controller="ChatForumController as ctrl">
          <div class="panel panel-default">
              <div class="panel-heading"><span class="lead"><img src='<c:url value='/static/images/image16.jpeg' />'
		align="right" alt="This is image" width="1000" height="90"></span></div>
            <br>  <div class="formcontainer">
                     ...
                     <input type="hidden" ng-model="ctrl.chatforum.id" />
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.chatforum.forumName" id="forumName" class="forumName form-control input-sm" placeholder="Enter forumName" required />
                              </div>
                          </div>
                      </div>
                       ...
                       <div class="row">
                          <div class="form-actions floatRight">
                              <input type="submit"  value="{{!ctrl.chatforum.id ? 'Add' : 'Update'}}" class="btn btn-primary btn-sm" ng-disabled="myForm.$invalid">
                ...
                <img src='<c:url value='/static/images/image16.jpeg' />'
		 alt="This is image" width="1000" height="300">
</body>
</html>