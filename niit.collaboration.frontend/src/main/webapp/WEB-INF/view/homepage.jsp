...
<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">Jobs<span class="caret"></span></a>
    ...
    <li class="active"><a href="viewusers">Send Request</a>
    <li class="active"><a href="acceptrejectrequest">Accept/Reject Request</a>
    <li class="active"><a href="unfriend">Unfriend</a>
    <li class="active"><a href="updateprofile">Update Profile</a>
    <li class="active"><a href="user/logout">Logout</a>
